...
and the CW Buddy wordmark on a dark rounded-square field. The repository-owned
1024 px master is the source for every platform asset and for the README image.
